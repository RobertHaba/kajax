...
<style scoped>
    ...
    .card-price-box__value{
        margin: 0;
        font-size: 2rem;
        font-weight: bold;
        color: #005492;
    }
    .card-price-box__info{
        margin: 0;
        font-size: 0.8rem;
        color: #005492;
        
    }
    .card-content-box__type{
        display: flex;
        justify-content: center;
        font-weight: bold;
    }
    .card-content-box__text{
        display: block;
        margin-left: 1rem;
        font-weight: normal;
    }
